...
//       home: MainScreen(email:"rehmanabdur643@gmail.com"),
//     );
//   }
// }
...
class MainScreen extends StatelessWidget {
  ...
  Widget _buildCategoryContainer(String imageUrl, String title, String description) {
    return Container(
  ...
  Widget _buildProductItem({required String imageUrl, required String price, required String description}) {
    return Container(
      decoration: BoxDecoration(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.account_circle, color: Colors.black), // Profile icon
            onPressed: () {},
          ),
        ],
      ),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    items: const [
                      DropdownMenuItem(value: 'Partywear', child: Text('Partywear')),
              ...
              Center(
                child: ElevatedButton(
                  ...
                  child: const Padding(
                    ...
                    child: Text('Buy It Now', style: TextStyle(color: Colors.white, fontSize: 16)),
                  ),
                ),
              ),
            ],
